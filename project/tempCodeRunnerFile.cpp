...
/*
//fungsi warna komplemen
tuple<int, int, int> warnaKomplemen(int &r, int &g, int &b) {
    r = 255 - r;
    g = 255 - g;       
    b = 255 - b;
    return {r, g, b};
...
//fungsi warna senada kanan
tuple<int, int, int> warnaSenadaKanan(int &r, int &g, int &b) {
    r = (r + 30 > 255) ? 255 : r + 30;
    g = (g + 30 > 255) ? 255 : g + 30;
    b = (b + 30 > 255) ? 255 : b + 30;
    return {r, g, b};
...
//fungsi warna senada kiri
tuple<int, int, int> warnaSenadaKiri(int &r, int &g, int &b) {
    r = (r - 30 < 0) ? 0 : r - 30;
    g = (g - 30 < 0) ? 0 : g - 30;
    b = (b - 30 < 0) ? 0 : b - 30;
    return {r, g, b};
